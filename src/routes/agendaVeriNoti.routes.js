...
import { postAgenda, postVerificacion, postNotificacion, getVerificaciones,validarAgenda,getAgendaPorCita,updateAgendaPorCita,getAgendaPorCitaEstado} from '../controladores/agenVeriNoti.js';
...
router.get('/agendaEstado/cita/:id_cita', verifyToken, getAgendaPorCitaEstado);
